...
syn keyword redPredefined random read rebcode? reblue rebol.com rebolor recycle red reduce refinement? reflect reform rejoin remainder remold remove remove-each rename repeat repend replace request-file resolve return reverse reword rm round
...
syn keyword redSpecial false off on no none rebol self true yes
